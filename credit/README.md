...
## How to Use
1. **Compile the Program**: Use a C compiler to compile the source code, e.g., `clang credit.c -o credit`.
2. **Run the Program**: Execute the compiled program and input the credit card number when prompted:
   ```bash
   ./credit
   Number: 4003600000000014
   VISA
   ```
3. **View Results**: The program will output the card type or indicate if the number is invalid.
